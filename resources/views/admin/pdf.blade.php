  ...
  <div class="adv-table" style="text-align: center;">
    <img alt="" src="{{ public_path('/ad_asset/img/logo.png') }}" style="width:50px;">
  	<table class="display table table-bordered table-striped" id="dynamic-table">
          ...
          <th style="background: #141514!important;color: #fff">Name</th>
          <th style="background: #141514!important;color: #fff">Number</th>
          <th style="background: #141514!important;color: #fff">Distributor</th>
